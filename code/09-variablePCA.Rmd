...
ggsave2(paste0("../results/Fig5_A-C_2.png"),
...
ggsave2(paste0("../results/Fig5_A-C_2.pdf"),
          plot_grid(p1.1, p3.1, p5.1, 
                    nrow = 1, 
                    ncol = 3, 
                    labels = NULL, 
...
ggsave2(paste0("../results/SFig19_2.png"),
...
ggsave2(paste0("../results/SFig19_2.pdf"),
          plot_grid(p1, p_legend, 
                    ncol = 1, 
                    labels = NULL, 
                    align = "hv",
...
ggsave2(paste0("../results/SFig20_2.png"),
          plot_grid(p1, p_legend, 
                    ncol = 1, 
                    labels = NULL, 
                    align = "hv",
...
ggsave2(paste0("../results/SFig20_2.pdf"),
          plot_grid(p1, p_legend, 
                    ncol = 1, 
                    labels = NULL, 
                    align = "hv",
...
ggsave2(paste0("../results/SFig21_2.png"),
          plot_grid(p1, p_legend, 
                    ncol = 1, 
                    labels = NULL, 
                    align = "hv",
...
ggsave2(paste0("../results/SFig21_2.pdf"),
          plot_grid(p1, p_legend, 
                    ncol = 1, 
                    labels = NULL, 
                    align = "hv",
...
ggsave2(paste0("../results/SFig22_2.png"),
          plot_grid(p1, p_legend, 
                    ncol = 1, 
                    labels = NULL, 
                    align = "hv",
...
ggsave2(paste0("../results/SFig22_2.pdf"),
          plot_grid(p1, p_legend, 
                    ncol = 1, 
                    labels = NULL, 
                    align = "hv",
...
ggsave2(paste0("../results/Fig5D-E_2.png"),
...
ggsave2(paste0("../results/Fig5D-E_2.pdf"),
          plot_grid(p1.2, NULL, p2.2, 
                    ncol = 3, 
                    labels = NULL, 
                    align = "hv",
