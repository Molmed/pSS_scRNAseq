...
saveRDS(DGE_list, "../results/DGE_patientGroups_celltypeFine_listAll.rds")
#DGE_list <- readRDS("../results/DGE_patientGroups_celltypeFine_listAll.rds")
...
DGE_list_p <- lapply(DGE_list, function(x) {
  ...
  p <- DotPlot(gex, features = rownames(a), group.by = "patient_group")
...
p_list <- list()
for (i in sort(unique(gex$cluster_cellType_manual_fine))[1:15]){
...
ggsave2("../results/DGE_dotplots_perCelltypeFine.png", 
        plot_grid(plotlist = p_list, ncol = 5, labels = NULL, align = "h"), 
...
saveRDS(DGE_list, "../results/DGE_patientGroups_celltypeMain_listAll.rds")
#DGE_list <- readRDS("../results/DGE_patientGroups_celltypeMain_listAll.rds")
...
p_list <- list()
for (i in sort(unique(gex$cluster_cellType_manual_main))[-6]){
...
ggsave2("../results/DGE_dotplots_perCelltypeMain.png", 
        plot_grid(plotlist = p_list, ncol = 6, labels = NULL, align = "h"), 
        width = 30, height = 15, unit = "cm")
table(gex$cluster_cellType_manual_main, gex$orig.ident)
