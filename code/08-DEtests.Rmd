...
#DGE_list <- DGE_list[c("DN", "Memory", "Naive", "Transitional")]
...
p1 <- plot_grid(plotlist = p_list, ncol = 4, labels = NULL, align = "h") + 
           bgcolor("white") + 
           border("white")
...
ggsave2(paste0("../results/Fig2B_GOBP.png"),
...
ggsave2(paste0("../results/Fig2B_GOBP.pdf"),
          plot_grid(plotlist = p_listBP, 
                    ncol = 4, 
                    labels = NULL, 
                    align = "vh" ) + bgcolor("white"),
...
gex@meta.data$cellMain_patient_group <- paste(gex$cluster_cellType_manual_main, gex$patient_group, sep="_")
Seurat::VlnPlot(gex, "BCL6", group.by = "cellMain_patient_group")
Seurat::VlnPlot(gex, "IGHM", group.by = "cellMain_patient_group")
Seurat::DotPlot(gex, ,features = c("BCL6", "AICDA", "FASLG"), group.by = "cellMain_patient_group")
