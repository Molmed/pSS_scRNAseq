...
saveRDS(gex, file = paste0("../results/GEX4_noRegression_", format(Sys.time(), "%y%m%d"), ".rds"))
...
saveRDS(gex, file = paste0("../results/GEX5_noRegression_", format(Sys.time(), "%y%m%d"), ".rds"))
...
saveRDS(gex, file = paste0("../results/GEX6_noRegression_", format(Sys.time(), "%y%m%d"), ".rds"))
...
saveRDS(gex, file = paste0("../results/GEX7_noRegression_", format(Sys.time(), "%y%m%d"), ".rds"))
...
Idents(object = gex) <- "orig.ident"
saveRDS(gex, file = paste0("../results/GEX8_noRegression_", format(Sys.time(), "%y%m%d"), ".rds"))
...
ggsave2(paste0("../results/FeaturePlot_allCells_pbmcMarkers_noRegression_", format(Sys.time(), "%y%m%d"), ".png"), 
        p.pbmc.f, 
...
p.b.markers.f <- FeaturePlot(gex, 
                             ...
                             raster=FALSE, 
                             order = TRUE)
ggsave2(paste0("../results/FeaturePlot_allCells_BMarkers_noRegression_", format(Sys.time(), "%y%m%d"), ".png"), 
        p.b.markers.f, 
...
ggsave2(paste0("../results/FeaturePlot_allCells_IGMarkers_noRegression_", format(Sys.time(), "%y%m%d"), ".png"), 
        p.ig.markers.f, 
        width=25, height=25, unit="cm")
...
p.myPars.f <- FeaturePlot(gex, 
                          ...
                          raster=FALSE, 
                          order = TRUE)
ggsave2(paste0("../results/FeaturePlot_allCells_myPars_noRegression_", format(Sys.time(), "%y%m%d"), ".png"), 
        p.myPars.f, 
        width=25, height=25, unit="cm")
