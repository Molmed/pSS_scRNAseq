...
## plot Figure 1C, Main cell types and IGH constant region expression (Fig1C)

```{r}

colors_cellTypeFine <- c(brewer.pal(5, "Blues"), 
  brewer.pal(4, "YlOrRd")[1],
  c("gray70", "gray50"),
  brewer.pal(4, "YlOrRd")[2:4],
  brewer.pal(3, "RdPu")[2],
  brewer.pal(3, "Greens")[c(3,2,1)],
  brewer.pal(3, "Purples")[3])
#show_col(colors_cellTypeFine)

colors_cellTypeMain <- colors_cellTypeFine[c(3, 9, 16, 7, 14, 12, 15)]

# display.brewer.pal(5, "Blues")  # DN - blue
# display.brewer.pal(4, "YlOrRd") # Memory - orange/red
# c("gray70", "gray50")           # Mem_str - gray
# display.brewer.pal(3, "Greens")[c(3,2,1)] # Naive - green
# display.brewer.pal(3, "Purples")[3]       # Memory_platelets - purple
# display.brewer.pal(3, "RdPu")[3]# Plasma cells - pink
...
ggsave2(paste0("../results/celltypesMain_withLabel.png"), 
        p1, 
...
## plot Figure 1D, UMAP for cellTypeFine (Fig1D)
...
p <- DimPlot(gex, 
             ...
             group.by = "cluster_cellType_manual_fine", 
             pt.size = 0.1, 
             cols = colors_cellTypeFine
             ) + 
  xlab("UMAP 1") + 
  ylab("UMAP 2") + 
  ggtitle("celltypes fine") + 
  theme(axis.text = element_blank(),
        axis.ticks = element_blank())

ggsave2(paste0("../results/Fig1D_4.png"), 
        p, 
...
## plot Figure 1E, dotplot for cluster marker genes Fig1E 
...
##  plot Figure 1F, patient subtypes per cell type (Fig1F)
...
colors_cellTypeFineClusters <- c(brewer.pal(5, "Blues"), 
  brewer.pal(4, "YlOrRd")[1],
  c("gray70", "gray50"),
  brewer.pal(4, "YlOrRd")[2:4],
  brewer.pal(3, "RdPu")[2],
...
ggsave2(paste0("../results/SFig4B_3.png"), 
        p, 
...
## plot SFig4D, Supplementary Figure SFig4D, violins split by cell type
