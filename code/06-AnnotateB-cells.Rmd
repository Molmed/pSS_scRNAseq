...
annotation_main <- c(
  ...
  Memory_str = 18, #FOS, CD69, EGR1, DUSP1
  Memory_Platelet = 19, #CCL5, F13A1, PPBP, NRGN, CLU
  Naive = 20,#
  Memory_str = 21,#dead/dying cells
  Plasma_cell = 22
)
...
ggsave2(paste0("../results/SFig3.pdf"), 
        plot_grid(p4, p3, ncol = 1, labels = NULL, rel_heights = c(4, 1)) + 
          bgcolor("white") + 
          border("white"), 
        width = 30, height = 30, unit = "cm")
...
### plot Fig1B-C, fine cell types and IGH constant region expression (cellTypeMain)
...
ggsave2(paste0("../results/Fig1B-C_main.png"), 
        plot_grid(p1, p2, 
                  ncol = 2, 
                  rel_widths = c(1, 1)) + 
          bgcolor("white") + 
...
ggsave2(paste0("../results/Fig1B-C_main.pdf"), 
        plot_grid(p1, p2, 
                  ncol = 2, 
                  rel_widths = c(1, 1)) + 
          bgcolor("white") + 
...
### plot Fig1D, dotplot for cluster marker genes (cellTypeMain)
...
ggsave2(paste0("../results/Fig1D_main.png"), 
        p, 
        width = 12, height = 14, unit = "cm") 

ggsave2(paste0("../results/Fig1D_main.pdf"), 
        p, 
        width = 12, height = 14, unit = "cm") 
...
###  plot Fig1E, patient subtypes per cell type fine
...
p3 <- plot_grid(p1, p2, 
                ncol = 1, labels = NULL, rel_heights = c(0.8, 1) , align = "v") + 
          bgcolor("white") + 
          border("white")
...
p1 <- ggplot(gex@meta.data, aes(x = reorder(cluster_cellType_manual_main,
...
p2 <- ggplot(gex@meta.data, aes(x = reorder(cluster_cellType_manual_main,
                                        -table(cluster_cellType_manual_main)[cluster_cellType_manual_main]), 
                                            fill = patient_group)) +
        theme_classic() +
        geom_bar(position = "fill") + 
...
#get legend
p_legend <- ggplot(gex@meta.data, aes(x = reorder(cluster_cellType_manual_main,
                                        -table(cluster_cellType_manual_main)[cluster_cellType_manual_main]), 
                                            fill = patient_group)) +
        theme_classic() +
        geom_bar(position = "fill") + 
...
ggsave2("../results/Fig1E_main.png", 
        plot_grid(p3, p_legend, 
                  ncol = 2, 
                  rel_widths = c(5, 1), 
                  labels = NULL, 
...
ggsave2("../results/Fig1E_main.pdf", 
        plot_grid(p3, p_legend, 
                  ncol = 2, 
                  rel_widths = c(5, 1), 
                  labels = NULL, 
...
### plot Fig1F, violins split by cell type (fine)
...
ggsave2("../results/Fig1F_main.png", 
        plot_grid(y_label, p1, 
                  ncol = 2, 
                  labels = NULL, 
                  align = "hv", 
          ...
          bgcolor("white") + 
          border("white"), 
        width = 40, height = 9, unit = "cm")

ggsave2("../results/Fig1F_main.pdf", 
        plot_grid(y_label, p1, 
                  ncol = 2, 
                  labels = NULL, 
                  align = "hv", 
...
### plot SFig4A, cellTypesMain by patient group
...
ggsave2(paste0("../results/SFig4A.png"), 
        p, 
        width = 20, height = 15, unit = "cm")

ggsave2(paste0("../results/SFig4A.pdf"), 
        p, 
        width = 20, height = 15, unit = "cm")
...
ggsave2(paste0("../results/SFig4B.pdf"), 
        p, 
        width = 18, height = 17, unit = "cm")
...
### plot SFig4C, celltype fine per patient subgroup 
...
ggsave2("../results/SFig4C.png", 
        p, 
        width = 20, height = 14, unit = "cm")

ggsave2("../results/SFig4C.pdf", 
        p, 
        width = 20, height = 14, unit = "cm")
...
### plot SFig4C, celltype main per patient subgroup 

```{r}

p <- ggplot(gex@meta.data, 
            aes(x = patient_group, 
                fill =  cluster_cellType_manual_main)) +
        scale_fill_manual(values = unname(colors_cellTypeMain)) +
        theme_classic() +
        geom_bar(position = "fill") + 
        ylab("proportion of cells") + 
        xlab("") +
        ggtitle("celltype main per patient subgroup") +
        theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1),
              legend.title = element_blank())

ggsave2("../results/SFig4C_main.png", 
        p, 
        width = 20, height = 14, unit = "cm")

ggsave2("../results/SFig4C_main.pdf", 
        p, 
        width = 20, height = 14, unit = "cm")
