...
### plot Fig1B-C, fine cell types and IGH constant region expression
...
### plot Fig1D, dotplot for cluster marker genes
...
#table(cell_summary$orig.ident)
#cell_summary <- cell_summary[!cell_summary$orig.ident == "P024", ]

#test plot
ggplot(cell_summary, aes(x = patient_group,
                           y = per)) + 
  geom_violin() +
  facet_grid(cols = vars(cluster_cellType_manual_main))

#cell_summary[cell_summary$patient_group == "SSAB" & cell_summary$cluster_cellType_manual_main == "Naive", ]
