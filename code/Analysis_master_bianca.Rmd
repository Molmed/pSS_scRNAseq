...
gex <- readRDS("../results/GEX1_210826.rds"); gex; mem_used()
...
#gex <- readRDS("/Users/gusarv/Documents/projekt/SjS/data/pss_bcells_scRNAseq/results/GEX15_210908.rds")
...
#auto annotation of clusters by singleR
...
mypar(1,1,mar = c(2,4,2,5), xpd=TRUE)
barplot(res4*100, las = 1, col = mypal, ylab = "Proportion of cells\n")
legend("topright", legend = rownames(res4), bty = "n",fill = mypal, inset=c(-0.15,0))
dev.off()
