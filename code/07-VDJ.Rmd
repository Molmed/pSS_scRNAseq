...
### VDJ gene usage
#### plot VDJ correlation Figure 3B and Supplementary Figure S11A-C
...
VDJ_cor <- function(i, #seurat object meta data containing data for VDJ gene usage
  ...
  p <- pheatmap::pheatmap(cor_tmp, 
                     ...
                     filename = paste0("../results/VDJ_Cor_", VDJgene, "_", 
                                        correl, "_per_cluster_PatientGroup_3.png"),
                     fontsize = 8, 
                     fontsize_row = 4, 
                     fontsize_col = 4,
                     border_color = NA,
...
## plot SFig13, IgH class per cellTypeFine per patient
...
ggsave2(paste0("../results/SFig13.png"), 
          plot_grid(p2, p_legend, ncol = 1, labels = NULL, align = "hv", rel_heights = c(1, 0.1)) +
          bgcolor("white") + 
          border("white"),
          width = 30, height = 25, unit = "cm")
