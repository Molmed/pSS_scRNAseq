...
head(annot_junc_aa)
xxx <- annot_junc_aa$junction_aa[annot_junc$cluster_no_airr %in% rownames(tmp)]
...
ggsave2(paste0("../results/VDJ_muCDR3_CelltypeFine_orig.ident_rprop.png"), 
          plot_grid(p1, labels = NULL, align = "h"),
          width = 25, height = 15, unit = "cm")
...
x <- factor(paste0(gex$cluster_cellType_manual_fine,"_",gex$patient_group))
mm <- sparse.model.matrix(~0+x)
