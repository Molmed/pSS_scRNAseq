...
VDJ_cor <- function(i, #seurat object meta data containing data for VDJ gene usage
  ...
  p <- pheatmap::pheatmap(cor_tmp, 
                     annotation_col = data.frame(cell_type = factor(sub("__.*", 
                                                                        "", 
                                                                        colnames(cor_tmp))),
                                                 patient_group = factor(sub(".*__", 
                                                                            "",
                                                                            colnames(cor_tmp))),
                                                 row.names = colnames(cor_tmp)),
                     annotation_colors = ann_cols[1:2],
                     breaks = seq(0, 1, length.out = 100),
                     filename = paste0("../results/", figNo, ".png"),
                     fontsize = 8, 
                     fontsize_row = 4, 
                     fontsize_col = 4,
                     border_color = NA,
...
p3 <- plot_grid(p1, p2, nrow = 2, labels = NULL,
 ...
 ggsave2(paste0("../results/Fig3C_3.png"),
...
ggsave2(paste0("../results/SFig11_.png"), 
...
ggsave2(paste0("../results/SFig16_1.png"),
...
png("../results/Fig4C_.png", width = 12, height = 11, units = "cm", res = 200)
...
ggsave2(paste0("../results/SFig13B_.png"),
...
ggsave2(paste0("../results/SFig14A_.png"), 
          p2,
          width = 30, height = 10, unit = "cm")
...
ggsave2(paste0("../results/SFig15_.png"), 
