...
VDJ_cor <- function(i, #seurat object meta data containing data for VDJ gene usage
  ...
  titles <- data.frame(gexnames = c("v_call", "d_call", "j_call", "c_gene_10x"),
                       outnames = c("IGHV", "IGHD", "IGHJ", "IGH c"))
  
  # print(titles$outnames[titles$gexnames == VDJgene])
  # print(data.frame(cell_type = factor(sub("__.*", "", colnames(cor_tmp))),
  #                  patient_group = factor(sub(".*__", "", colnames(cor_tmp))),
...
for (j in c("png", "pdf")){
  p <- pheatmap::pheatmap(cor_tmp, 
                     ...
                     filename = paste0("../results/", figNo, ".", j),
                     fontsize = 10, 
                     fontsize_row = 4, 
                     fontsize_col = 4,
                     border_color = NA,
...
cor.p.c_call <- VDJ_cor(gex.meta, "pearson", "c_gene_10x", "SFig9A")
cor.p.d_call <- VDJ_cor(gex.meta, "pearson", "d_call", "SFig9B")
cor.p.j_call <- VDJ_cor(gex.meta, "pearson", "j_call", "SFig9C")
...
p1 <- ggplot(tmp, aes(x = reorder(gene, -seq_freq), 
                      ...
                      colour = patient_group)) +
      theme_classic() +
      ggtitle(expression(~italic(IGH)~'VDJ gene usage per patient group')) +
      theme(axis.text.x = element_blank(),
            axis.ticks.x = element_blank(),
            legend.position = "none",
            plot.margin = unit(c(0.2, 0, 0, 0), "cm")) +
...
p3 <- plot_grid(p1, p2, nrow = 2, labels = NULL,
 ...
 ggsave2(paste0("../results/Fig3D.png"),
  ...
  ggsave2(paste0("../results/Fig3D.pdf"),
          plot_grid(p3, p_legend, 
                    ncol = 2, 
                    labels = NULL, 
                    align = "v", 
...
ggsave2(paste0("../results/SFig12A-B.png"), 
...
ggsave2(paste0("../results/SFig12A-B.pdf"), 
          plot_grid(pd, pj, align = "hv", labels = NULL, ncol = 1) +
          bgcolor("white") + 
          border("white"),
          width = 15, height = 18, unit = "cm", dpi = 300)
...
ggsave2(paste0("../results/SFig11.pdf"), 
          plot_grid(p1, ncol = 1, labels = NULL, align = "h")+ 
          bgcolor("white") + 
          border("white"),
          width = 15, height = 10, unit = "cm")
...
corsiero$dataset <- "Corsiero_et_al"
corsiero$gender <- "F"
...
tmp <- as.data.frame.matrix(table(gex.meta$cluster_no_airr,
                                  gex.meta$orig.ident))
length(CDR3_data$CDR3)
length(unique(CDR3_data$CDR3))
...
ann_cols <- list(group = c(Corsiero_et_al = brewer.pal(9, "YlOrRd")[2],
                           Visser_et_al = brewer.pal(9, "YlOrRd")[5],  
                           Wang_et_al = brewer.pal(9, "YlOrRd")[7], 
                           `SSA-`= "#7CAE00",
                           `SSA+` = "#00BFC4", 
                           SSAB = "#C77CFF"))
...
pheatmap(res, 
         show_rownames = FALSE, 
         show_colnames = FALSE, 
         filename = paste0("../results/Fig4D_.", i),
...
ggsave2("../results/Fig3E.png", 
        plot_grid(p1, p2, ncol = 2, labels = NULL, align = "h") + 
          bgcolor("white") + 
          border("white"), 
        width = 30, height = 14, unit = "cm")

ggsave2("../results/Fig3E.pdf", 
        plot_grid(p1, p2, ncol = 2, labels = NULL, align = "h") + 
          bgcolor("white") + 
          border("white"), 
        width = 30, height = 14, unit = "cm")
...
#### plot Fig3G mu freq by IGHV gene, celltype and pat gr.
...
ggsave2(paste0("../results/Fig3G.png"),
        p_list[["Memory_Cl"]],
          width = 15, height = 10, unit = "cm")

ggsave2(paste0("../results/Fig3G.pdf"),
        p_list[["Memory_Cl"]],
          width = 15, height = 10, unit = "cm")
...
#### plot SFig24 mu freq for IGHV4-34, per celltype and sample.
...
ggsave2(paste0("../results/Fig3H.png"),
        p_list[["Memory_Cl"]],
          width = 15, height = 10, unit = "cm")

ggsave2(paste0("../results/Fig3H.pdf"),
        p_list[["Memory_Cl"]],
          width = 15, height = 10, unit = "cm")

ggsave2(paste0("../results/SFig24.png"),
        plot_grid(p2, p_legend, ncol = 1, labels = NULL, align = "hv", rel_heights = c(1, 0.1)) + 
          bgcolor("white") + 
          border("white"),
          width = 30, height = 25, unit = "cm")

ggsave2(paste0("../results/SFig24.pdf"),
        plot_grid(p2, p_legend, ncol = 1, labels = NULL, align = "hv", rel_heights = c(1, 0.1)) + 
          bgcolor("white") + 
          border("white"),
          width = 30, height = 25, unit = "cm")
...
ggsave2(paste0("../results/SFig14A.pdf"), 
          p2,
          width = 30, height = 10, unit = "cm")
...
ggsave2(paste0("../results/SFig14B.pdf"), 
          plot_grid(p3, labels = NULL, align = "h")+ 
          bgcolor("white") + 
          border("white"),
          width = 30, height = 10, unit = "cm")
...
ggsave2(paste0("../results/SFig10A.pdf"), 
          plot_grid(p, p_legend, 
                    ncol = 1, labels = NULL, 
                    align = "hv", rel_heights = c(1.5, 0.2)) + 
          bgcolor("white") + 
...
ggsave2(paste0("../results/SFig10B.pdf"), 
          plot_grid(p2, p_legend, ncol = 1, labels = NULL, align = "hv", rel_heights = c(1, 0.1)) +
          bgcolor("white") + 
          border("white"),
          width = 30, height = 25, unit = "cm")
...
### plot SFig17A, clonotypes per patient per cellTypeMain
...
ggsave2(paste0("../results/SFig17A.png"), 
          plot_grid(p, p_legend, 
                    ncol = 1, labels = NULL, 
                    align = "hv", rel_heights = c(1.5, 0.2)) + 
          bgcolor("white") + 
...
ggsave2(paste0("../results/SFig17A.pdf"), 
          plot_grid(p, p_legend, 
                    ncol = 1, labels = NULL, 
                    align = "hv", rel_heights = c(1.5, 0.2)) + 
          bgcolor("white") + 
...
### plot SFig17B, clonotypes per patient per cellTypeFine
...
ggsave2(paste0("../results/SFig17B.png"), 
          plot_grid(p2, p_legend, ncol = 1, labels = NULL, align = "hv", rel_heights = c(1, 0.1)) +
          bgcolor("white") + 
          border("white"),
          width = 30, height = 25, unit = "cm")

ggsave2(paste0("../results/SFig17B.pdf"), 
          plot_grid(p2, p_legend, ncol = 1, labels = NULL, align = "hv", rel_heights = c(1, 0.1)) +
          bgcolor("white") + 
          border("white"),
          width = 30, height = 25, unit = "cm")
