...
## create and subset data frame based on gex@metafor plotting
...
p2 <- ggplot(gex.meta, aes(x = cluster_cellType_manual_fine, 
                           fill = c_gene_10x)) +
      theme_classic() +
...
p1 <- DimPlot(gex, 
              ...
              order = c("Single (0 < X <= 1)",
                        ...
                        "Medium (5 < X <= 20)",
                        "Large (20 < X <= 100)"), 
              cols = c(brewer.pal(4, "Dark2"), "grey")) +
              theme(legend.position = "none") +
  ggtitle("clonotype") +  
  xlab("UMAP 1") + 
  ylab("UMAP 2") + 
