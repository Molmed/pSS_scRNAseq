...
####  plot Fig3A, IgH class per cell type fine
...
ggsave2("../results/Fig3A_main.png", 
        plot_grid(p1, p2, ncol = 2, labels = NULL, align = "h", rel_widths = c(1.5, 1)) + 
          bgcolor("white") + 
          border("white"), 
        width = 25, height = 14, unit = "cm")

ggsave2("../results/Fig3A_main.pdf", 
        plot_grid(p1, p2, ncol = 2, labels = NULL, align = "h", rel_widths = c(1.5, 1)) + 
          bgcolor("white") + 
          border("white"), 
        width = 25, height = 14, unit = "cm")
...
colors_cellTypeFine2 <- colors_cellType[c("memory5", "dn1", "dn2", "dn3", "dn4", "dn5",
                         "memory1", "memory3", "memory4", "naive2", "naive4", "naive6")]
...
#### plot SFig11A, allele usage for differentially used IGHV genes IGHV1-69
...
ggsave2(paste0("../results/SFig11A.png"), 
          plot_grid(p1, ncol = 1, labels = NULL, align = "h")+ 
          bgcolor("white") + 
          border("white"),
          width = 15, height = 10, unit = "cm")

ggsave2(paste0("../results/SFig11A.pdf"), 
          plot_grid(p1, ncol = 1, labels = NULL, align = "h")+ 
          bgcolor("white") + 
          border("white"),
          width = 15, height = 10, unit = "cm")
...
#### plot SFig11B?, VDJ gene usage per patient group
...
p3 <- plot_grid(p1, p2, nrow = 2, labels = NULL,
 ...
 ggsave2(paste0("../results/SFig11B.png"),
          plot_grid(p3, p_legend, 
                    ncol = 2, 
                    labels = NULL, 
                    align = "v", 
  ...
  ggsave2(paste0("../results/SFig11B.pdf"),
          plot_grid(p3, p_legend, 
                    ncol = 2, 
                    labels = NULL, 
                    align = "v", 
...
#### plot SFig12A-B, top IGHD and IGHJ genes per patient subgroup
...
### clonal expansion
#### plot Fig4A, cloneType per cell type fine based on compairr data (cellTypeFine)
...
ggsave2("../results/Fig4A_main.png", 
        plot_grid(p1, p2, ncol = 2, labels = NULL, align = "h") + 
          bgcolor("white") + 
          border("white"), 
        width = 30, height = 14, unit = "cm")

ggsave2("../results/Fig4A_main.pdf", 
        plot_grid(p1, p2, ncol = 2, labels = NULL, align = "h") + 
          bgcolor("white") + 
          border("white"), 
        width = 30, height = 14, unit = "cm")
...
## mutation status
####  plot Fig3D, mutation load per cell type fine
...
ggsave2("../results/Fig3D_main.png", 
        plot_grid(p1, p2, ncol = 2, labels = NULL, align = "h", rel_widths = c(1.5, 1)) + 
          bgcolor("white") + 
          border("white"), 
        width = 25, height = 14, unit = "cm")

ggsave2("../results/Fig3D_main.pdf", 
        plot_grid(p1, p2, ncol = 2, labels = NULL, align = "h", rel_widths = c(1.5, 1)) + 
          bgcolor("white") + 
          border("white"), 
        width = 25, height = 14, unit = "cm")
...
#### plot Fig3E, total VDJ mutation frequency - celltypeFine - patient_group
...
#### plot Fig3E, total VDJ mutation frequency - celltypeFine - patient_group - box
...
p1 <- ggplot(gex.meta, 
      ...
      ylab("mutated bp (%)") +
      xlab("") +
      scale_y_continuous(labels = scales::percent_format(accuracy = 1L), limits = c(0, 0.15)) +
      scale_fill_discrete(name = "") +
  geom_boxplot(alpha = 0.8, na.rm = TRUE, outlier.shape = NA)

ggsave2(paste0("../results/Fig3E_box.png"), 
          p1,
          width = 15, height = 8, unit = "cm")

ggsave2(paste0("../results/Fig3E_box.pdf"), 
          p1,
          width = 15, height = 8, unit = "cm")
...
ggsave2(paste0("../results/Fig3E_main.png"), 
          p1,
          width = 12, height = 10, unit = "cm")

ggsave2(paste0("../results/Fig3E_main.pdf"), 
          p1,
          width = 12, height = 10, unit = "cm")
...
#### plot Fig3F mu freq by IGHV gene, celltype and pat gr.
